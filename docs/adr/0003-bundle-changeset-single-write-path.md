...
so refusals carry the same Report the CLI produces, by construction. The
implementation hides the bundle overlay, lossless concept round-trip, index/log
maintenance (through the ADR-0004 model), and multi-file staging with rollback.
