...
/// validation order.
final List<OkfSpecRule> reservedRuleEntries = <OkfSpecRule>[
  baseRule(
  ...
  _indexRule(
    ...
    (source) => <String>[
      if (source.document.hasFrontmatter && !_isRootVersionFrontmatter(source))
...
/// A base rule that checks every parseable `index.md` independently.
...
/// A base rule that checks every parseable `log.md` independently.
