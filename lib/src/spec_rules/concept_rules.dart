...
final List<OkfSpecRule> conceptRules = List<OkfSpecRule>.unmodifiable(
  <OkfSpecRule>[
    _conceptRule(
      'missing-frontmatter',
    ...
    _conceptRule(
      ...
      (id, document) {
        ...
        final events =
            verified is List<Object?> ? verified : <Object?>[verified];
        return <String>[
          if (events.isEmpty ||
              events.any(
                (event) =>
    ...
    _conceptRule(
      ...
      (id, document) {
        ...
        return <String>[
          if (status != null &&
              (status is! String ||
                  !const <String>{'draft', 'stable', 'deprecated'}
                      .contains(status)))
        ...
        return <String>[
          if (_isAttestedComputation(document) &&
              ...
              (parameters is! List<Object?> ||
                  parameters.any((parameter) => !_isComputationParameter(
                        parameter,
                      ))))
...
typedef _ConceptCheck = Iterable<String> Function(
  OkfConceptId id,
