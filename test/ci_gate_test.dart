      ...
      test('homebrew job releases the tap from the published assets', () async {
        ...
        expect(
          ...
          allOf(
            ...
            contains(
              r'HOMEBREW_TAP_TOKEN: ${{ secrets.HOMEBREW_TAP_GH_TOKEN }}',
            ),
        ...
        final unsupported = Directory('${temporary.path}/manifest')
          ..createSync();
        File(
          '${unsupported.path}/platforms.tsv',
        ).writeAsStringSync('Plan9\tRISCV\tplan9-latest\tokf-plan9-riscv\n');
